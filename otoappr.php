...
$pagetitle = "SAO WSU | Otorisasi Purchase Request";
$namahalaman = "OTORISASI PURCHASE REQUEST";
                    ...
                    <div class="ecommerce-widget">
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header">Purchase Request</h5>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal" id="up_cancle">Tutup</button>
                </div>
                </form>   
            </div>
        </div>
