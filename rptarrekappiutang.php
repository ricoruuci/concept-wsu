...
$pagetitle = "SAO WSU | Laporan Rekap Piutang";
$namahalaman = "REKAP PIUTANG PELANGGAN ";
...
<body>
                    ...
                    <div class="ecommerce-widget">
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header">Laporan Piutang Pelanggan</h5>
                                    <div class="card-body">
    ...
    <script>
    var namafile = 'rptarrekappiutangsys.php';
